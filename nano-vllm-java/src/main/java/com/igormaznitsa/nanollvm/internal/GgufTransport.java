 ...
 * interpret architecture families — that is {@link ModelBinding}.
 */
public final class GgufTransport implements AutoCloseable {
  ...
  public WeightBag loadWeights(final boolean allowUnpackParameters, final LlmListener io) {
