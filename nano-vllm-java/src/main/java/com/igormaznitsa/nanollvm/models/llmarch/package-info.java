 ...
 * graph). Embedding families extend {@link EmbeddingArchitecture}. Not exported; application code
 * loads through {@link com.igormaznitsa.nanollvm.models.LlmModelFactory}.
 *
 * @since 1.1.0
 */
