 ...
 * {@link #TEXT_TO_TEXT}, {@link #TEXT_TO_EMBEDDING}, {@link #AUDIO_TO_TEXT},
 * {@link #TEXT_TO_AUDIO}, or {@link #TEXT_TO_LABELS} — see {@link LlmModel#usableModalities()}.
 *
...
public record LlmModalities(Set<LlmModality> input, Set<LlmModality> output) {
  ...
  /**
   * fastText (and similar) text classification: text in, ranked labels out.
   *
   * @since 1.4.0
   */
  public static final LlmModalities TEXT_TO_LABELS = of(LlmModality.TEXT, LlmModality.LABELS);
  ...
  public static LlmModalities usable(
    ...
    return usable(embedding, speech, synthesis, false);
  }
   ...
   * @param speech         {@code true} for Whisper speech-to-text
   * @param synthesis      {@code true} for Piper text-to-speech
   * @param classification {@code true} for fastText (or similar) classifiers
   * @return {@link #TEXT_TO_LABELS}, {@link #TEXT_TO_AUDIO}, {@link #AUDIO_TO_TEXT},
   * {@link #TEXT_TO_EMBEDDING}, or {@link #TEXT_TO_TEXT}
   * @since 1.4.0
   */
  public static LlmModalities usable(
    final boolean embedding,
