/**
 * Runnable demos ({@link HelloWorld}, {@link LogTriageHelloWorld}, {@link AdvisorRagHelloWorld},
 ...
 * model menu, RAG mode, advisor count, then a line-oriented chat or embed session).
 */
